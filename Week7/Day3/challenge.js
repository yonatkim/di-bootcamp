const exampleRequest = "https://v6.exchangerate-api.com/v6/2da679e756c26a1fd73e5711/latest/USD"

const apiKey = '2da679e756c26a1fd73e5711';
...
function fetchCurrencies() {
    ...
    lines.forEach(line => {
        ...
        currencies.push({ "Code": code, "Name": name, "Country": country });
    });

    const jsonData = JSON.stringify(currencies, null, 2);
...
async function handleConversion() {
    ...
    try {
        ...
        resultElement.textContent = 'Failed to convert currency. Please try again later.';
    }
}
